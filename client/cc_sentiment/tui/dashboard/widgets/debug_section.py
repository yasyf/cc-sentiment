# DELETE_AFTER_SCREENS: Dashboard-specific composite — DebugState panel
# tied to the scoring pipeline. Move next to the dashboard screen file when
# the dashboard is extracted from app.py into its own screen.
